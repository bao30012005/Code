...
public class Task {
    ...
    public String toString() {
        return String.format(Validation.DISPLAY_FORMAT, id, requirementName, taskTypeID, date, Double.parseDouble(planTo) - Double.parseDouble(planFrom), assignee, reviewer);
    }
